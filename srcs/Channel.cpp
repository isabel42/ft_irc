...
void	Channel::addToKicked(std::string &kicked_name)
{
	...
	std::cout << kicked_name << " is now kicked from the channel " << getName() << std::endl;
}
...
void	Channel::addToBanned(std::string &banned_name)
{
	...
	std::cout << banned_name << " is now banned from the channel " << getName()<< std::endl;
}
...
void	Channel::addToVoiced(std::string &voiced_name)
{
	...
	std::cout << voiced_name << " is now voiced from the channel " << getName() << std::endl;
}
